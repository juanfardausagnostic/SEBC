...
```
[root@ip-172-31-15-226 ~]# yum list mariadb-server
Loaded plugins: amazon-id, rhui-lb, search-disabled-repos
Available Packages
mariadb-server.x86_64                                1:5.5.52-1.el7                                rhui-REGION-rh
[root@ip-172-31-15-226 ~]#
[root@ip-172-31-15-226 ~]# yum install mariadb-server
Loaded plugins: amazon-id, rhui-lb, search-disabled-repos
...
(2/38): mariadb-5.5.52-1.el7.x86_64.rpm                                                                                | 8.6 MB  00:00:00
(3/38): perl-5.16.3-291.el7.x86_64.rpm                                                                                 | 8.0 MB  00:00:00
...
(7/38): mariadb-server-5.5.52-1.el7.x86_64.rpm                                                                         |  11 MB  00:00:00
...
(16/38): perl-Filter-1.49-3.el7.x86_64.rpm                                                                             |  76 kB  00:00:00
...
(33/38): perl-libs-5.16.3-291.el7.x86_64.rpm                                                                           | 688 kB  00:00:00
(34/38): perl-macros-5.16.3-291.el7.x86_64.rpm                                                                         |  43 kB  00:00:00
...
Start MariaDB
```
[root@ip-172-31-4-207 ~]# systemctl start mariadb
[root@ip-172-31-4-207 ~]# systemctl enable mariadb
Created symlink from /etc/systemd/system/multi-user.target.wants/mariadb.service to /usr/lib/systemd/system/mariadb.service.
[root@ip-172-31-4-207 ~]# systemctl status mariadb
● mariadb.service - MariaDB database server
   Loaded: loaded (/usr/lib/systemd/system/mariadb.service; enabled; vendor preset: disabled)
   Active: active (running) since Mon 2017-02-13 05:48:23 EST; 19s ago
 Main PID: 3845 (mysqld_safe)
   CGroup: /system.slice/mariadb.service
           ├─3845 /bin/sh /usr/bin/mysqld_safe --basedir=/usr
           └─4240 /usr/libexec/mysqld --basedir=/usr --datadir=/var/lib/mysql --plugin-dir=/usr/lib64/mysql/plugin --...

Feb 13 05:48:13 ip-172-31-4-207.ap-southeast-1.compute.internal mariadb-prepare-db-dir[3769]: See the MariaDB Knowled...
Feb 13 05:48:13 ip-172-31-4-207.ap-southeast-1.compute.internal mariadb-prepare-db-dir[3769]: MySQL manual for more i...
Feb 13 05:48:13 ip-172-31-4-207.ap-southeast-1.compute.internal mariadb-prepare-db-dir[3769]: You can start the Maria...
Feb 13 05:48:13 ip-172-31-4-207.ap-southeast-1.compute.internal mariadb-prepare-db-dir[3769]: cd '/usr' ; /usr/bin/my...
Feb 13 05:48:13 ip-172-31-4-207.ap-southeast-1.compute.internal mariadb-prepare-db-dir[3769]: You can test the MariaD...
Feb 13 05:48:13 ip-172-31-4-207.ap-southeast-1.compute.internal mariadb-prepare-db-dir[3769]: cd '/usr/mysql-test' ; ...
Feb 13 05:48:13 ip-172-31-4-207.ap-southeast-1.compute.internal mariadb-prepare-db-dir[3769]: Please report any probl...
Feb 13 05:48:13 ip-172-31-4-207.ap-southeast-1.compute.internal mysqld_safe[3845]: 170213 05:48:13 mysqld_safe Loggi....
Feb 13 05:48:13 ip-172-31-4-207.ap-southeast-1.compute.internal mysqld_safe[3845]: 170213 05:48:13 mysqld_safe Start...l
Feb 13 05:48:23 ip-172-31-4-207.ap-southeast-1.compute.internal systemd[1]: Started MariaDB database server.
Hint: Some lines were ellipsized, use -l to show in full.
[root@ip-172-31-4-207 ~]#
```
Set the MariaDB root password
```
[root@ip-172-31-4-207 ~]# mysql_secure_installation
...
Setup MariaDB JDBC
```
[root@ip-172-31-4-207 ec2-user]# ls -l /usr/share/java
ls: cannot access /usr/share/java: No such file or directory
[root@ip-172-31-4-207 ec2-user]# mkdir /usr/share/java
[root@ip-172-31-4-207 ec2-user]# ls -l /usr/share |grep java
drwxr-xr-x.   2 root root     6 Feb 13 06:05 java
[root@ip-172-31-4-207 ec2-user]# cd mysql-connector-java-5.1.40
[root@ip-172-31-4-207 mysql-connector-java-5.1.40]# cp mysql-connector-java-5.1.40-bin.jar /usr/share/java/mysql-connector-java.jar
[root@ip-172-31-4-207 mysql-connector-java-5.1.40]# ls -l /usr/share/java
total 968
